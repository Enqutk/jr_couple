...
class EntitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            [
                'name' => 'JR Couple on TikTok',
                'type' => EntityTypeEnum::post,
                'source' => PostSourceEnum::social,
                'category' => 'JR Couple',
                'link' => 'https://www.tiktok.com/@ruthandjonas',
                'description' => 'Follow Ruth and Jonas — tap to watch on TikTok.',
                'order' => 3,
            ],
            [
                'name' => 'Hair looks on Instagram',
                'type' => EntityTypeEnum::post,
                'source' => PostSourceEnum::social,
                'category' => 'Ruties Hair',
                'link' => 'https://www.instagram.com/ruthishair/',
                'description' => 'Installs and care tips from Ruth’s Hair — opens on Instagram.',
                'order' => 4,
            ],
            [
                'name' => 'JR Mobile on Instagram',
                'type' => EntityTypeEnum::post,
                'source' => PostSourceEnum::social,
                'category' => 'JR Mobile',
                'link' => 'https://www.instagram.com/j.r_mobiles/',
                'description' => 'Phones and deals from JR Mobile — opens on Instagram.',
                'order' => 5,
            ],
        ];
